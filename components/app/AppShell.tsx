...
const NAV: Record<Role, NavItem[]> = {
  student: [
    ...
    { label: 'Messages', icon: Mail, to: '', href: '/portal/messages' },
  ...
  parent: [
    ...
    // One inbox shared by every role, rather than four copies of it.
    { label: 'Messages', icon: Mail, to: '', href: '/portal/messages' },
  ...
  tutor: [
    ...
    { label: 'Help requests', icon: LifeBuoy, to: '/help' },
    { label: 'Performance', icon: LineChart, to: '/performance' },
    { label: 'Writing', icon: PenLine, to: '', href: '/portal/blog' },
    { label: 'Messages', icon: Mail, to: '', href: '/portal/messages' },
    { label: 'Help forum', icon: MessagesSquare, to: '', href: '/forum' },
    { label: 'My profile', icon: UserRound, to: '', href: '/portal/profile' },
  ],
  admin: [
    ...
    { label: 'Contact inbox', icon: Inbox, to: '/contact' },
    { label: 'Writing', icon: PenLine, to: '', href: '/portal/blog' },
    { label: 'Messages', icon: Mail, to: '', href: '/portal/messages' },
    { label: 'Help forum', icon: MessagesSquare, to: '', href: '/forum' },
    { label: 'My profile', icon: UserRound, to: '', href: '/portal/profile' },
